...
// renderOrderSummart();//regenerate html code to update the page this call MVC
// Model View Controller - MVC - 
// 1. Model - saves and managed the data 
// 2. View - takes data and displays in page HTML
// 3. Controller - run javascript code to make it interactive
//  these 3 interact with each other
